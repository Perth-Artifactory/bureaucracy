...
\definechangesauthor[color=red]{FIXME}
...
\definechangesauthor{CAP10-Committee-Election}
\definechangesauthor{CAP11-Payments-To-Committee-Members}
\definechangesauthor{CAP12-Multiple-Bank-Accounts}
...
\pagebreak
\listofchanges[style=list, show=comment|added|deleted|replaced]
