...
\item The \chreplaced[id=proofing]{committee}{management committee} shall have the power to make, alter and rescind any by-laws that it considers necessary for the effective administration of the \chreplaced[id=proofing]{Association}{association}, provided that no by-law may be inconsistent with the rules of \chreplaced[id=proofing]{the Association}{association}. \chcomment{This needs revision.} \chcomment{This clause is additional to those in the Model Rules. In the model rules, by-laws can only be made by resolution at a general meeting.}
