...
\part*{\chadded[id=proofing]{Guidance Notes}}

\chcomment{Call this section "Guidance Notes" for now, because (correct or not) that is how items C and D are called out in the text. This should be revised.}
