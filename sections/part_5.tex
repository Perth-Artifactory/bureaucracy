...
\item The following are the office bearers of the Association --- \label{officebearer-roles}
...
\item A person may be a committee member if the person is --- \label{committee-eligibility}
  ...
  \end{enumerate}
\item A person must not hold 2 or more of the offices mentioned in rule \ref{officebearer-roles} at the same time.
...
\item At least 21 days before an annual general meeting, the secretary must send written notice to all the members ---
  ...
  \item stating the date by which nominations must be received by the secretary to comply with rule \ref{notice-of-consideration-for-election-committee}
  \end{enumerate}
...
\item The term of office of a committee member begins when the member ---
  ...
  \end{enumerate}
\item Subject to rule \ref{term-of-office}, a committee member holds office until the positions on the committee are declared vacant at the next annual general meeting.
...
\item At a general meeting, the Association may by resolution --- 
  ...
  \end{enumerate}
\item A committee member who is the subject of a proposed resolution under rule \ref{remove-committee-member-resolution} may make written representations (of a reasonable length) to the secretary or chairperson and may ask that the representations be provided to the members.
...
\item Unless rule \ref{unanimous-vote-urgent-business} applies, the only business that may be conducted at the meeting is the business described in the notice.
...
\item Members or other person who is not a committee member may attend a committee meeting if invited to do so by the committee. \label{meeting-invitation-for-non-committee}
\item A person invited under rule \ref{meeting-invitation-for-non-committee} to attend a committee meeting ---
...
\item A member who participates in a committee meeting as allowed under rule \ref{electronic-participation-committee-meeting-acceptable-to-secretary-and-chair} is taken to be present at the meeting and, if the member votes at the meeting, the member is taken to have voted in person.
\end{enumerate}
...
\item Subject to rule \ref{committee-doesnt-meet-quorum} no business is to be conducted at a committee meeting unless a quorum is present.
...
\item If ---
  ...
  \item a quorum is not present within 30 minutes after the commencement time of a committee meeting held under rule \ref{meeting-adjourned-due-to-no-quorum}; and
