...
\item \label{number-of-committee-members} The \chreplaced[id=proofing]{committee}{Management Committee} must consist of at least 5 but not more than 10 \chadded[id=proofing]{committee} members. \chcomment{Variance to the model rules.  (1) The committee members consist of — (a) the office holders of the Association; and (b) at least one ordinary committee member. (2) The committee must determine the maximum number of members 
...
\item \chdeleted[id=CAP10-Committee-Election]{Proxy votes will be allowed under rule \ref{proxies}. Proxy votes must reach the Secretary prior to the commencement of the meeting.} \chcomment{Variance to model rules: This rule does not exist in the model rules. Why is it needed? Is this not already implicit in the rules for proxies? Suggest deleting this clause.}\chcomment[id=RC]{Clause is not in model laws. Is it necessary, or does s.54 cover this}
\end{enumerate}
...
\chcomment{Variance to the model rules: "Election of office holders" comes before "Election of ordinary committee members". We do things differently so this is intended.}
...
\item \chdeleted[id=CAP10-Committee-Election]{The newly elected \chreplaced[id=proofing]{committee}{Committee} must decide by vote on office \chreplaced[id=proofing]{holders}{bearers} of the Association and any other officers/roles} \chcomment[id=RC]{do we want to be able to able to have ordinary members fill positions other than office bearers? How do ordinary members nominate? Clarify this in relation to s.49} for the Association. \chcomment{Taken literally, this would mandate that we must appoint all officers and roles (even things like the Member Storage Officer) at the first meeting.}

\item \chdeleted[id=CAP10-Committee-Election]{If there is no nomination for a position, the chairperson of the meeting  will appoint a member \chadded[id=RC]{to the position}.} \chcomment[id=RC]{Do we specify how this role (chairperson of the meeting) is decided?}
...
\item \chdeleted[id=CAP10-Committee-Election]{If more than one \chdeleted[id=proofing]{committee} member  has nominated for a position, the \chdeleted[id=proofing]{committee} members at the meeting must vote by secret ballot.} \chcomment[id=RC]{Is this wording intentional? Other places leave it open for ordinary members to fill positions}
...
\item \chdeleted[id=CAP10-Committee-Election]{On the \chdeleted[id=proofing]{committee} member's election, the new chairperson of the Association may take over as the chairperson of the meeting.} \chcomment[id=RC]{insert after 35.2, and a clause that the chairperson is the first elected.}
...
\item A committee member is \textbf{not}\chcomment{Variance to model rules: In the model rules, committee members \textbf{are} entitled to be paid for travel expenses.}  entitled to be paid out of the funds of the Association for any out-of-pocket expenses for travel and accommodation incurred ---
...
\chcomment[id=RC]{Model rules do not have "not".... would we not be prepared to pay travel costs in some cases for some things?? like to events where they are promoting Artifactory??}

\chcomment{Open to discussion on this. I think the intent here was to prevent commitee members from claiming travel to committee meetings and general meetings. Theoretically, there could be some merit in allowing claims for travel that is in association with other business, e.g. travelling to Brisbane to inspect an expensive machine before buying it for the Artifactory. In practice, our current finances wouldn't allow for that magnitude of travel costs.}
...
\item The \chreplaced{committee}{Management Committee} will meet at least once every two months. \chcomment{Variance to the model rules: The committee must meet at least 3 times in each year on the dates, and at the times and places, determined by the committee.}
...
\item Special committee meetings may be convened by the chairperson or any 3 \chcomment[id=RC]{Model rules are 2} committee members.
\end{enumerate}
...
\item The minutes must record the following ---
  ...
  \end{enumerate}
\item The minutes of a committee meeting must be entered in the Association's \chreplaced[id=proofing]{minute book}{minute record} within 7 days after the meeting is held. \chcomment{Model rules have 30 days.}
\item The committee must ensure that the minutes of a committee meeting are reviewed \chadded[id=proofing]{and approved} as correct by a motion at the next committee meeting. \chcomment{Variation to model rules:  (4) The chairperson must ensure that the minutes of a committee meeting are reviewed and signed as correct by —  (a) the chairperson of the meeting; or (b) the chairperson of the next committee meeting.} \chcomment[id=RC]{model rules have this as the responsibility of the chairperson to sign}
\item When the minutes of a committee meeting have been accepted\chcomment{Variation to model rules: "accepted" vs "signed"} as correct they are, until the contrary is proved, evidence that ---
...
\chcomment[id=RC]{Consider how our inserted rule 35 works with this clause.}
