...
\item A person may be a committee member if the person is --- \label{committee-eligibility}
  ...
  \end{enumerate}
\item A person must not hold 2 or more of the offices mentioned in \chreplaced[id=proofing]{subrule}{rule} \ref{officebearer-roles} at the same time.
\item The office bearers referred to in rule \ref{officebearer-roles} will form the Executive Committee. \chcomment{Variance to the model rules. Why does the term "executive committee" need to be defined? It is not used anywhere else in this document. Is it referenced in bylaws?}
\end{enumerate}
...
\item \chadded[id=CAP2-Permissive-Written-Notice-For-Committee]{Notices to the secretary for the purposes of rules 33.2 and 33.3 must be either ---}
  ...
  \begin{enumerate}
    ...
    \item \chadded[id=CAP2-Permissive-Written-Notice-For-Committee]{A notice sent to the secretary using an online communication platform administered by the Association.}
  \end{enumerate}
...
\note {
Variations from the Model Rules include:

\begin{itemize}
  \item Notice period for AGM reduced from 42 days to 21 days.
  \item Notice period for committee member nominations reduced from 28 days before the AGM to 7 days before the AGM.
  \item There is no clause requiring that nominations be for a specific office holding position.
  \item (CAP2-Permissive-Written-Notice-For-Committee) Nomination process changed to permit a wider range of ways that a nomination (and the seconding of that nomination) can be notified to the secretary.
\end{itemize}
...
\chcomment{Variance to model rules: These rules elect all committee members as ordinary committee members, with election to specific offices being handled at the first committee meeting, which must occur immediately after the AGM.}

\begin{enumerate}

\item At the annual general meeting, the Association must decide by resolution the number of ordinary committee members (if any) to hold office for the next year. \chcomment{Refer to this from the Annual General Meeting section, so all provisions for the AGM are in the same section.}
...
\subsection{Election of office \chreplaced[id=proofing]{holders}{bearers}}\label{election-of-office-bearers}}
...
\item The office \chreplaced[id=proofing]{holders}{bearers} of the Association are determined by the elected committee after the annual general meeting. \chcomment{Tighten this up. Specify that this must take place at the first committee meeting and that the first committee meeting must be held within 7 days of an AGM.}
\item The newly elected \chreplaced[id=proofing]{committee}{Committee} must decide by vote on office \chreplaced[id=proofing]{holders}{bearers} of the Association and any other officers/roles \chcomment[id=RC]{do we want to be able to able to have ordinary members fill positions other than office bearers? How do ordinary members nominate? Clarify this in relation to s.49} for the Association. \chcomment{Taken literally, this would mandate that we must appoint all officers and roles (even things like the Member Storage Officer) at the first meeting.}
\item If there is no nomination for a position, the chairperson of the meeting \chcomment[id=RC]{Do we specify how this role (chairperson of the meeting) is decided?} will appoint a member \chadded[id=RC]{to the position}.
\item If only one member has nominated for a position, the chairperson of the meeting must declare the \chreplaced[id=proofing]{member}{Member} elected to the position.
\item If more than one \chdeleted[id=proofing]{committee} member \chcomment[id=RC]{Is this wording intentional? Other places leave it open for ordinary members to fill positions} has nominated for a position, the \chdeleted[id=proofing]{committee} members at the meeting must vote by secret ballot.
\item Each \chdeleted[id=proofing]{committee} member present at the meeting may vote for one member who has nominated for the position.
\item A \chdeleted[id=proofing]{committee} member who has nominated for \chreplaced[id=proofing]{a}{the} position may vote for themselves.
\item On the \chdeleted[id=proofing]{committee} member's election, the new chairperson of the Association may take over as the chairperson of the meeting. \chcomment[id=RC]{insert after 35.2, and a clause that the chairperson is the first elected.}
\end{enumerate}
...
\item A committee member is \textbf{not}\chcomment{Variance to model rules: In the model rules, committee members \textbf{are} entitled to be paid for travel expenses.} \chcomment[id=RC]{Model rules do not have "not".... would we not be prepared to pay travel costs in some cases for some things?? like to events where they are promoting Artifactory??} entitled to be paid out of the funds of the Association for any out-of-pocket expenses for travel and accommodation incurred ---
...
\item The date, time and place of the first committee meeting must be determined by the committee members as soon as practicable after the annual general meeting at which the committee members are elected. \chcomment{Refer comments above about tightening up the timing of the first committee meeting after the AGM.}
