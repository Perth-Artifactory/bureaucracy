...
\item At least 21 \chcomment{Variance to model rules: 42 days.} days before an annual general meeting, the secretary must send written notice to all the members ---
  ...
  \item stating the date by which nominations must be received by the secretary to comply with \chreplaced[id=proofing]{subrule}{rule} \ref{notice-of-consideration-for-election-committee}
  \end{enumerate}
...
\item A member whose nomination does not comply with this rule is not eligible for election to the committee unless the member is nominated under rule \ref{nominating-committee-less-than-elected}. \chcomment{Variance to Model Rules: No clause about nominations for specific offices.}
\end{enumerate}
...
\item The newly elected \chreplaced[id=proofing]{committee}{Committee} must decide by vote on office \chreplaced[id=proofing]{holders}{bearers} of the Association and any other officers/roles for the Association. \chcomment{Taken literally, this would mandate that we must appoint all officers and roles (even things like the Member Storage Officer) at the first meeting.}
...
\item If more than one \chdeleted{committee} member has nominated for a position, the \chdeleted{committee} members at the meeting must vote by secret ballot.
\item Each \chdeleted{committee} member present at the meeting may vote for one member who has nominated for the position.
\item A \chdeleted{committee} member who has nominated for \chreplaced[id=proofing]{a}{the} position may vote for themselves.
\item On the \chdeleted{committee} member's election, the new chairperson of the Association may take over as the chairperson of the meeting.
\end{enumerate}
...
\item A committee member is \textbf{not}\chcomment{Variance to model rules: In the model rules, committee members \textbf{are} entitled to be paid for travel expenses. A reasonable variation.} entitled to be paid out of the funds of the Association for any out-of-pocket expenses for travel and accommodation incurred ---
...
\item The Management Committee will meet at least once every two months. \chcomment{Variance to the model rules: The committee must meet at least 3 times in each year on the dates, and at the times and places, determined by the committee.}
...
\item The committee must ensure that the minutes of a committee meeting are reviewed as correct by a motion at the next committee meeting. \chcomment{Variation to model rules:  (4) The chairperson must ensure that the minutes of a committee meeting are reviewed and signed as correct by —  (a) the chairperson of the meeting; or (b) the chairperson of the next committee meeting.}
