...
\item Participation in meetings via electronic communications technology shall be considered attendance if acceptable to the Secretary and Chair. \label{electronic-participation-committee-meeting-acceptable-to-secretary-and-chair} \chcomment{Badly drafted. Tighten this up.}
\item A member who participates in a committee meeting as allowed under \chreplaced[id=proofing]{subrule}{rule} \ref{electronic-participation-committee-meeting-acceptable-to-secretary-and-chair} is taken to be present at the meeting and, if the member votes at the meeting, the member is taken to have voted in person.
\end{enumerate}
...
\item If a quorum is not present within 30 minutes after the notified commencement time of a committee meeting --- \label{no-quorum-after-30min}
  ...
  \item the committee members present may elect to wait up to another 60 minutes for the quorum to be present \chcomment{Variance to model rules - no such clause. Suggest this is deleted.}
...
\item The minutes must record the following ---
  ...
  \end{enumerate}
\item The minutes of a committee meeting must be entered in the Association's minute record within 7 days after the meeting is held. \chcomment{Variation to model rules: "Minute book" instead of "minute record". Seems like a well-meaning change, however the entire rest of the document refers to "books" as defined at the start. Suggest this be changed back to "minute book". Also, 7 days instead of 30 days.}
\item The committee must ensure that the minutes of a committee meeting are reviewed as correct by a motion at the next committee meeting. \chcomment{Variation to model rules:  (4) The chairperson must ensure that the minutes of a committee meeting are reviewed and signed as correct by —  (a) the chairperson of the meeting; or (b) the chairperson of the next committee meeting.} \chcomment[id=RC]{model rules have this as the responsibility of the chairperson to sign}
