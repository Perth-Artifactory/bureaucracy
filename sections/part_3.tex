...
\setcounter{enumi}{0}
\item \chadded[id=CAP3-Community-Shed]{the committee accepts the application; and}
...
\item \label{swap-ordinary-associate-membership} If a particular class of membership is in use, the Association does not have the right except at a \chreplaced[id=proofing]{general meeting}{General Meeting} to change a class of \chadded[id=proofing]{ordinary} membership to an \chreplaced[id=proofing]{class of associate membership}{Associate Class} or vice versa.
\end{enumerate}
...
\item A person ceases to be a member when any of the following takes place ---
  ...
  \item \chadded[id=CAP4-Corporate-Members]{for a member that is a body corporate, the body corporate is wound up;}
