...
\item The committee must not accept an application unless the applicant ---
  ...
  \end{enumerate} \chcomment{Variance to model rules: Rule about rejecting applications is deleted.}
\item The committee must notify the applicant of the committee's decision to reject an application as soon as practicable after making the decision. \chcomment{Variance to model rules: model rules require both acceptance or rejection to be notified.}
