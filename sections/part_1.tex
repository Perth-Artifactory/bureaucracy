...
\subsection{\chreplaced[id=proofing]{Terms used}{Definitions}} \label{terms-used}
...
\item \chadded[id=CAP2-Permissive-Written-Notice-For-Committee]{\textbf{direct message} means a message sent directly to a person using the primary online communication platform administered by the Association.}
\item \chadded[id=CAP9-Emergency-Disciplinary-Action]{\textbf{EDA} means an emergency disciplinary action under rule \ref{emergency-disciplinary-actions}.}
\item \chdeleted[id=CAP10-Committee-Election]{\textbf{executive committee} means the office \chreplaced[id=proofing]{holders}{bearers} of the Association;} \chcomment{The term "executive committee" is not used anywhere else in these rules. The only other usage in our official documentation is in our Code of Conduct.}
\item \textbf{financial records} includes ---
  ...
  \item working papers and other documents needed to explain ---
    ...
    \item adjustments to be made in preparing financial statements; \chcomment[id=FIXME]{Need some formatting help here. These should be labelled i) and ii).}
    \end{enumerate}
  \end{enumerate}
...
\item \textbf{financial year}\chadded[id=proofing]{,} of the Association, has the meaning given in \chreplaced[id=proofing]{Key Information, item \ref{key-info-financial-year}}{rule 2};
...
\item \textbf{\chreplaced[id=proofing]{office holder}{officer bearer}} \chreplaced{means the committee members listed in subrule \ref{office-holders}.}{ -- refers to the Chairperson, Treasurer, Secretary, Vice Chairperson}
\item \textbf{ordinary committee member} means a committee member who is not an office holder of the Association under \chreplaced[id=proofing]{subrule \ref{office-holders}}{rule 28.1};
