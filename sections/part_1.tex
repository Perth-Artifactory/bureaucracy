...
\item \textbf{ordinary committee member} means a committee member who is not an office holder of the Association under \chhighlight{rule 28.1};
...
\item \textbf{subcommittee} means a subcommittee appointed by the committee under \chhighlight{rule 49.1.a};
