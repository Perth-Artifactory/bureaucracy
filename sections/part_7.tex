...
The funds of the Association may be derived from entrance fees, subscriptions\comment{Variation from the model rules, which say "annual subscriptions".},  donations, fund-raising activities, grants, interest and any other sources approved by the committee.
...
\item All cheques, drafts, bills of exchange, promissory notes and other negotiable instruments of the Association must be signed by ---
  ...
  \end{enumerate}
\item All funds of the Association must be deposited into the Association's account within 10 working days after their receipt unless otherwise approved by the by-laws. \comment{Variation from the model rules, which have:  All funds of the Association must be deposited into the Association's account within 5 working days after their receipt. }
\end{enumerate}
...
\item Without limiting \replaced[id=proofing]{subrule}{rule} \ref{committee-ensure-financial-requirements-met}, those requirements include ---
