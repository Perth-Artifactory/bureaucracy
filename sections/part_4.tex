...
% \comment{Dvision numbering is broken. This should be div 1. Fixed as of 02/12/22. }
...
\item This Division (Pt \ref{part-4-disciplinary-action-disputes-and-mediation}, Div \ref{division-4-mediation}) applies if written notice has been given to the secretary requesting the appointment of a mediator ---
  ...
  \item by a party to a dispute under rule \replaced[id=proofing]{\ref{grievance-appoint-mediator}}{21.5.b.i} or \ref{dispute-appoint-mediator}.
  \end{enumerate}
...
\item \deleted[id=proofing, comment={Duplicate text}]{Rule 22- applies if written notice has been given to the secretary requesting the appointment of a mediator ---}

  \begin{enumerate}
  
  \item \deleted[id=proofing, comment={Duplicate text}]{by a member under rule \ref{expulsion-written-notice}; or}
  \item \deleted[id=proofing, comment={Duplicate text}]{by a party to a dispute under rule \replaced[id=proofing]{\ref{grievance-appoint-mediator}}{21.5.b.i} or \ref{dispute-appoint-mediator}.}
  \end{enumerate}
\item The mediator must be a person chosen ---
  ...
  \item if the appointment of a mediator was requested by a party to a dispute under rule \replaced[id=proofing]{\ref{grievance-appoint-mediator}}{21.5.b.i} or \ref{dispute-appoint-mediator} --- by agreement between the parties to the dispute. \label{mediator-chosen-2}
  \end{enumerate}
...
\item The person appointed as mediator by the committee must be a person who acts as a mediator for another not-for-profit body, such as a community legal centre, if the appointment of a mediator was requested by --- \label{mediator-chosen-3}
  ...
  \item a party to a dispute under rule \replaced[id=proofing]{\ref{grievance-appoint-mediator}}{21.5.b.i}; or
