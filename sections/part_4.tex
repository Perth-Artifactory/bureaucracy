...
\item The committee may decide to impose an emergency disciplinary action on a member, if ---
...
\item Emergency disciplinary actions must be initiated by a committee member and seconded by another committee member.

\item \label{emergency-disciplinary-action-initial-notice} Emergency disciplinary actions against a member take effect as soon as a committee member gives notice  to the member (the \textbf{initial notice}), either ---
...
\item \label{emergency-disciplinary-action-formal-notice} A committee member must deliver a written notice within 72 hours of the initial notice to ---
...
\item The notice given under subrule \ref{emergency-disciplinary-action-formal-notice} must state ---

  \begin{enumerate}
  \item That the committee has imposed an emergency disciplinary action on the member.
  \item The reason why the committee has imposed an emergency disciplinary action.
  \item The restrictions imposed by the emergency disciplinary action.
  \item The date of the initial notice given under subrule \ref{emergency-disciplinary-action-initial-notice}
  \item The date when the emergency disciplinary action expires.
  \item That the member is entitled to raise a dispute under XXXX or request mediation under YYYY of the rules.
  \end{enumerate}

\item The duration of an emergency disciplinary action must not exceed 31 days after the initial notice.

\item The member may submit written representations of reasonable length to be considered by the committee. Written representations must be recieved by the secretary within 7 days of the initial notice.

\item Each emergency disciplinary action must be reviewed by the committee within 14 days of the initial notice.
...
\item The effects of an emergency disciplinary actions may include:
...
* Preventing a member from initiating the grievance procedure (Div \ref{division-3-resolving-disputes}) or requesting the appointment of a mediator (Div \ref{division-4-mediation}).
* Preventing an ordinary member from attending or voting at a general meeting.
* Preventing a member who is a committee member from voting as a committee member.
