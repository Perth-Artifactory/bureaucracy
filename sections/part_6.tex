...
\begin{enumerate}
  ...
  \item Subject to subrule \ref{proxy-for-no-more-than-5-other-members}, an ordinary member may appoint an individual who is an ordinary member as their proxy to vote and speak on their behalf at a general meeting.
  ...
  \item If the committee has approved a form for the appointment of a proxy, the member may use that form or any other form ---
        ...
        \end{enumerate}
  \item Notice of a general meeting given to an ordinary member under rule \ref{notice-of-general-meetings} must --- \label{notice-of-meeting-to-appointed-proxy}
...
\subsection{General meeting at more than one place} \label{general-meeting-at-more-than-one-place}

\note{Taken from the constitution of the West Australian Cricket Association.}

\begin{enumerate}
  \item A general meeting may be held in two or more places linked together by any technology that: \label{general-meeting-at-more-than-one-place-part-a}
        \begin{enumerate}
          \item gives the members as a whole in those places a reasonable opportunity to participate in proceedings; and
          \item enables the chair of the meeting to be aware of proceedings in each place; and
          \item enables the members in each place to vote on a show of hands and on a poll.
        \end{enumerate}
  \item If a general meeting is held in two or more places under subrule \ref{general-meeting-at-more-than-one-place-part-a} ---
        \begin{enumerate}
          \item a member present at one of the places is taken to be present at the meeting; and
          \item the chair of that meeting may determine at which place the meeting is taken to have been held.
        \end{enumerate}
\end{enumerate}
...
\begin{enumerate}
  ...
  \item A special resolution is required if it is proposed at a general meeting --- \label{special-resolution-required-when}
        ...
        \end{enumerate}
  \item Subrule \ref{special-resolution-required-when} does not limit the matters in relation to which a special resolution may be proposed.
