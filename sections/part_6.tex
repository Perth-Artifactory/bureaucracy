...
\item The annual general meeting of the Association \chreplaced[id=proofing]{must}{will} take place within 3 months of the end of each financial year.
...
\item Subject to \chreplaced[id=proofing]{subrule}{rule} \ref{proxy-for-no-more-than-5-other-members}, an ordinary member may appoint an individual who is an ordinary member as their proxy to vote and speak on their behalf at a general meeting.
...
\item \chdeleted[id=CAP5-Meeting-At-More-Than-One-Place]{Participation in meetings via electronic communications technology shall be considered attendance if acceptable to the Secretary and Chair.} \label{electronic-participation-general-meeting-acceptable-to-secretary-and-chair}
...
\item If ---
  ...
  \item \chreplaced[id=proofing]{either 10 ordinary members, or 10 percent of the ordinary members of the Association, are present at the meeting,}{the \chreplaced[id=proofing]{lesser}{lessor} of 10 or 10\% ordinary members are present at the meeting, }\chcomment{Variance to model rules - "at least 2 ordinary members are present at the meeting," }
  \end{enumerate}
...
\item The chairperson must ensure that the minutes of a general meeting are \chreplaced[id=proofing]{endorsed}{reviewed} as correct by a motion \chreplaced[id=proofing]{at}{of} the next general meeting.

\chcomment{Variance to model rules - review.  (5) The chairperson must ensure that the minutes of a general meeting are reviewed and signed as correct by —   (a) the chairperson of the meeting; or  (b) the chairperson of the next general meeting. }

\chcomment[id=FIXME]{A year between AGMs is a long time to wait to endorse the minutes. Would it be suitable for the chairperson to endorse the minutes after an AGM by e.g. editing the minutes on our wiki to state "I endorse these minutes"?}

\item When the minutes of a general meeting have been \chreplaced[id=proofing]{endorsed}{signed} \chcomment{As per rule above, minutes are never "signed"} as correct they are, in the absence of evidence to the contrary, taken to be proof that ---
