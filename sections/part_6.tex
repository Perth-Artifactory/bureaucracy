...
\item The annual general meeting of the Association \replaced[id=proofing]{must}{will} take place within 3 months of the end of each financial year. \comment{Variation from the model rules, which allows for AGMs to be held later than 3 months after the end of a a financial year.}
...
\item The ordinary business of the annual general meeting is as follows ---
  ...
  \item to receive and consider ---
    ...
    \end{enumerate}
  \item to elect the committee members; \comment{Variation from the model rules - "To elect the office holders of the Association and other committee members".}
...
\item The members requiring a special general meeting to be convened must ---
  ...
  \end{enumerate}
\item The special general meeting must be convened within 28 days after notice is given under \replaced[id=proofing]{subrule}{rule} \ref{special-general-meeting-written-notice-to-secretary}
...
\item A special general meeting convened by members under \replaced[id=proofing]{subrule}{rule} \ref{no-sgm-within-28-days-despite-written-request} ---
...
\item The secretary or, in the case of a special general meeting convened under \replaced[id=proofing]{subrule}{rule} \ref{no-sgm-within-28-days-despite-written-request}, the members convening the meeting, must give to each member ---
...
\item Subject to \replaced[id=proofing]{subrule}{rule} \ref{proxy-for-no-more-than-5-other-members}, an ordinary member may appoint an individual who is an ordinary member as their proxy to vote and speak on their behalf at a general meeting.
...
\item If the committee has approved a form for the appointment of a proxy, the member may use that form or any other form ---
  ...
  \end{enumerate}
\item Notice of a general meeting given to an ordinary member under rule \replaced[id=proofing]{\ref{notice-of-general-meetings}}{50} must --- \label{notice-of-meeting-to-appointed-proxy}
...
\item Participation in meetings via electronic communications technology shall be considered attendance if acceptable to the Secretary and Chair. \label{electronic-participation-general-meeting-acceptable-to-secretary-and-chair} \comment{This clause varies from the Model Rules for no really good reason.}
\item A member who participates in a general meeting as allowed under \replaced[id=proofing]{subrule}{rule} \ref{electronic-participation-general-meeting-acceptable-to-secretary-and-chair} is taken to be present at the meeting and, if the member votes at the meeting, the member is taken to have voted in person.
\end{enumerate}
...
\item Quorum for a committee meeting is stated in Guidance Note E. \comment{Revise constitution to clarify what "Guidance Notes" are intended to refer to.}
...
\item If a quorum is not present within 30 minutes after the notified commencement time of a general meeting ---
  ...
  \item the members present may elect to wait up to another 60 minutes for the quorum to be present; or \comment{Variance to the model rules, which have no such clause. Suggest deleting this clause.}
...
\item If ---
  ...
  \item a quorum is not present within 30 minutes after the commencement time of an annual general meeting held under \replaced[id=proofing]{subrule}{rule} \ref{adjourned-annual-general-meeting}; and
  \item the \replaced[id=proofing]{lesser}{lessor} of 10 or 10\% ordinary members are present at the meeting, \comment{Variance to model rules - "at least 2 ordinary members are present at the meeting," }
  \end{enumerate}
...
\item Without limiting \replaced[id=proofing]{subrule}{rule} \ref{chairperson-may-adjourn-meeting-with-consent}, a meeting may be adjourned ---
...
\comment{Variance from the model rules - The provisions for voting by members who are body corporates have been deleted. Should add these back so that we can have corporate members, i.e. corporate sponsors. Subrules (2) through (4) and mods to subrule (8).}

  \begin{enumerate}
  
  \item subject to \replaced[id=proofing]{subrule}{rule} \ref{chairperson-has-casting-vote-if-votes-tied}, each ordinary member has one vote; and
...
\item For a person to be eligible to vote at a general meeting as an ordinary member, they
  ...
  \item must have paid any fee or other money payable to the Association by the member. \comment{Subject of a CAP.}
  \end{enumerate}
\end{enumerate}
...
\item A special resolution is required if it is proposed at a general meeting --- \label{special-resolution-required-when}
  ...
  \end{enumerate}
\item \replaced[id=proofing]{Subrule}{rule} \ref{special-resolution-required-when} does not limit the matters in relation to which a special resolution may be proposed.
...
\item Subject to \replaced[id=proofing]{subrule}{rule} \ref{if-poll-on-any-question-is-demanded}, the chairperson of a general meeting may, on the basis of general agreement or disagreement or by a show of hands, declare that a resolution has been --- \label{chairperson-declare-resolution-based-on-show-of-hands}
  ...
  \item lost.
  \end{enumerate}
\item If the resolution is a special resolution, the declaration under \replaced[id=proofing]{subrule}{rule} \ref{chairperson-declare-resolution-based-on-show-of-hands} must identify the resolution as a special resolution.
\item If a poll is demanded on any question by the chairperson of the meeting or by at least 3 other ordinary members present in person or by proxy --- \label{if-poll-on-any-question-is-demanded}
  ...
  \end{enumerate}
\item If a poll is demanded on the election of the committee \comment{Variance from the model rules, which state "chairman", not "committee".} or on a question of an adjournment, the poll must be taken immediately.
...
\item A declaration under \replaced[id=proofing]{subrule}{rule} \ref{chairperson-declare-resolution-based-on-show-of-hands} or \ref{if-poll-on-any-question-is-demanded} must be entered in the minutes of the meeting, and the entry is, without proof of the voting in relation to the resolution, evidence of how the resolution was determined.
\end{enumerate}
...
\item In addition, the minutes of each annual general meeting must record ---
  ...
  \end{enumerate}
\item The minutes of a general meeting must be entered in the Association's minute record within 7 days \comment{Variance to model rules - 30 days} after the meeting is held.
\item The chairperson must ensure that the minutes of a general meeting are reviewed as correct by a motion of the next general meeting. \comment{Variance to model rules - review.  (5) The chairperson must ensure that the minutes of a general meeting are reviewed and signed as correct by —   (a) the chairperson of the meeting; or  (b) the chairperson of the next general meeting. }
\item When the minutes of a general meeting have been signed \comment{As per rule above, miinutes are never "signed"} as correct they are, in the absence of evidence to the contrary, taken to be proof that ---
